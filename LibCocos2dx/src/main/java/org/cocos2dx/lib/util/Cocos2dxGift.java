...
public class Cocos2dxGift {
    ...
    public void play(Cocos2dxView cocos2dxView,final Cocos2dxGiftModel gift,final Cocos2dxGiftControlModel control){
        cocos2dxView.updateView(new Runnable() {
            @Override
            public void run() {
                play2(gift.aniName,gift.imagePath,gift.plistPath,gift.exportJsonPath,control.speedScale,control.scale,control.x,control.y);
            }
        });
    }
    ...
    public static class Cocos2dxGiftControlModel{
