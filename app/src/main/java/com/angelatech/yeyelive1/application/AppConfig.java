...
public class AppConfig {
    ...
    //系统初始化生成目录名字常量
    public static final String FILEPATH_ROOT_NAME = "yeye";
    public static final String FILEPATH_CACHE_NAME = "cache";
    public static final String FILEPATH_VOICE_NAME = "voice";
    ...
    //service Action
    public static final String SERVICE_ACTION = "com.angelatech.yeyelive1.IService";
    public static final String PACKAGE_NAME = "com.angelatech.yeyelive1";
    //AppsFlyerLib
